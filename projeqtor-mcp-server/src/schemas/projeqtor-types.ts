...
export const objectClass = z.string().describe('ProjeQtOr object class name');
...
export const activitySchema = z.object({
  ...
  parentId: z.string().optional().describe('Parent activity ID'),
});
...
export const schemas = {
  ...
  project: projectSchema, activity: activitySchema, ticket: ticketSchema,
  resource: resourceSchema, work: workSchema, risk: riskSchema,
  issue: issueSchema, expense: expenseSchema, budget: budgetSchema,
  meeting: meetingSchema, document: documentSchema, assignment: assignmentSchema,
  searchCriteria: searchCriteriaSchema, dateRange: dateRangeSchema,
};
