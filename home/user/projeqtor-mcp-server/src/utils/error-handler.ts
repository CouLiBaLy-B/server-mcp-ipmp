/**
 * Standardized MCP error wrapper.
 * Every tool catches errors and returns them as structured JSON-RPC compatible results.
 */
export class McpToolError extends Error {
  ...
  constructor(
    message: string,
    {
      ...
      retryable = false,
      cause,
    }: { code?: string; retryable?: boolean; cause?: Error } = {},
  ) {
    super(message);
...
/** Wrap a function to catch and format errors as MCP results */
